...
export default function Header() {
    return (
        <header className='relative w-screen max-w-[1920px] lg:h-[550px] md:h-[400px] h-[300px] bg-no-repeat bg-cover overflow-hidden'>
            <div className="relative top-1/2 -translate-y-1/2">
                <div className='glow glow-rgb mx-auto lg:mb-8 md:mb-6 mb-2 lg:size-52 md:size-48 size-36 rounded-full shadow-2xl'>
                    <img className='w-full h-full object-cover object-center rounded-full' src='/pfp.jpg' />
                </div>
                <div className="w-fit mx-auto md:p-1 p-0.5 lg:mb-8 md:mb-6 mb-2 bg-black shadow-xl">
